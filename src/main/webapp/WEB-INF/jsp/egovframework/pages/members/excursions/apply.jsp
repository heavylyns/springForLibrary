		...
		<div class="sub_cont_wrap">
			...
			<div class="bbs_wrap">
					...
					<div class="title">
						...
						<div class="author">
							<ul>
								...
								<li class="wid33"><span class="author_title wid50">내 용</span> 동화구연</li>
								<li class="wid100"><span class="author_title wid50">일 시</span> 2016-10-07 오후 2:00:00 ~ 오후 6:00:00</li>
							</ul>
						</div>
					</div>
				</div><!-- //bbs_view -->
				...
				<div class="bbs_write">
					...
					<dl>
						<dt>단체명</dt>
						<dd><input type="text" name="apply_name" style="width:200px;" title="이름 입력" value=""></dd>
						<dt>연락처</dt>
						<dd>
						...
						<dt>참가인원</dt>
						<dd><input type="text" name="apply_name" style="width:50px;" title="참가인원 입력" value=""> 명</dd>
						<dt>비밀번호</dt>
					...
					<div class="apply_list">
						<p class="apply_guide">견학신청 인원 : <strong>13</strong>/20명</p>
						<ul>
							<li>
								<span class="name">동면****</span>
								<span>010-****-2233</span>
								<span>8명</span>
