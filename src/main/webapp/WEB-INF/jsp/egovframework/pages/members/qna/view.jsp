		...
		<div class="sub_cont_wrap">
			...
			<h3 class="title_h3">묻고답하기</h3>
					...
					<div class="bbs_wrap">
						...
						<div class="step_wrap">
							<ul>
								<li><span class="step_no">?</span><span class="step_txt">질문등록</span><span class="step_arrow"></span></li>
								<li class="active"><span class="step_no">∞</span><span class="step_txt">처리중</span><span class="step_arrow"></span></li>
						...
						<div class="btn_wrap textAlign_right">
							<a href="bbs_list.html" class="btn btn_point">수정</a>
							<a href="bbs_list.html" class="btn btn_basic">목록</a>
						</div>
						...
						<div class="bbs_reply">
							...
							<p>
							답변내용입니다.<br>
							답변은 이러궁저러쿵 이리저리해서 요리조리한데 이럴땐 이렇게 저렇게 하세요.
							</p>
						</div>
						<div class="btn_wrap textAlign_right">
							...
							<a href="write_reply.html" class="btn btn_point">답변수정</a>
						</div>
